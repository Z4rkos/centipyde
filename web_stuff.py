...
def get_args():
    ...
    parser.add_argument(
        "--chunk_size", help="Size of chunk the wordlist should be split into (default = 100000). If len(wordlist) * 2 < chunk size it will not be split.", default=100000, type=int)
    parser.add_argument(
